...
\command{S.lower(),S.upper(),S.swapcase()}{}
...
\command{c=[nu**2 for nu in b {if nc<3}]                         }{ list comprehension}
...
\command{del(dict["a"],dict.pop("b")}{}
\command{if "key1" in D:}{}

\subsection{Sort}
\begin{lstlisting}[language=Python]
def cmp(e0, e1): # return 1,0,-1 for cmp
    pass
[1, 3, -1, 100, -50].sort(cmp)
# or
...
\begin{itemize}
    \item{\_\_init\_\_, \_\_del\_\_}
    \item{\_\_repr\_\_: Return string for print}
    \item{\_\_call\_\_: What?}
    \item{\_\_cmp\_\_: As comparator}
\end{itemize}
...
# except (SystemExit, KeyboardInterrupt):
    ...
    logger.error('Failed to open', exc_info=True)
else:
    logger.info('open', exc_info=True)
finally:
    close();
\end{lstlisting}
...
with WithClass() as f:
    f. xxxx
    # WithClass need __enter__ and __exit__
    # or
